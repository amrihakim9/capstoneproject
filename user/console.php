      ...
      <nav class="navbar top-navbar navbar-expand-md navbar-light">
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
          ...
          <ul class="navbar-nav float-right">
            ...
            <li class="nav-item dropdown">
              <span class="nav-link nama"><?= $name ?></span>
            </li>
          </ul>
        </div>
      </nav>
  ...
  <script>
     $(document).ready(function() {
       Swal.fire({
         ...
         icon: 'info',
         width: 800,
         text: 'Selamat Datang di Terminal Switch. Pada halaman ini, terdapat terminal yang menunjukkan bahwa TTY mana saja yang tersedia. Jadi mohon untuk User dapat memperhatikan hal tersebut. Setelah mengetahui TTY mana saja yang tersambung atau tersedia, User dapat memilih TTY yang tersedia di bawah terminal tersebut. Itu saja informasi yang dapat diberikan. Terima kasih.',
     });
  });
  </script>
</body>
